    ...
    <main style={{ maxWidth: 480, margin: '0 auto' }}>
      ...
      <section style={{ padding: '24px 20px 28px', background: '#07182a' }}>
        ...
        <div style={{ marginBottom: 14 }}>
          ...
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: 'rgba(227,62,51,0.15)', border: '1px solid rgba(227,62,51,0.5)', borderRadius: 8, padding: '6px 14px', fontSize: '0.72rem', fontWeight: 700, color: '#ff7a72', letterSpacing: '0.04em' }}>
